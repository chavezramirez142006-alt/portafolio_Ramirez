...
const Habilidades = () => {
    /*
 Arreglo de datos: Simulamos la información que podría venir de una API
*/
    ...
    const skillsData = [
        ...
        },
        {
            ...
            descripcion: "SQL, T-SQL, Optimización, ProcedimientosAlmacenados.",nivel: "Avanzado",
            botonTexto: "VER CERTIFICADO",
            estado: "completado"
        },
        {
        ...
        },
        {
            id: 4,
            titulo: "Excel / VBA",
            descripcion: "Macros, Power Pivot, Power Query, Pivot Tables,Dashboards complejos.",nivel: "Experto",
            botonTexto: "VER CERTIFICADO",
            estado: "completado"
        },
        {
        ...
        },
        {
            id: 6,
            titulo: "React",
            descripcion: "Construcción de Interfaces de Usuario Modernas apartir de Componentes",nivel: "Aprendizaje Activo",
            botonTexto: "VER CERTIFICADO",
            estado: "completado"
        },
        {
            id: 7,
            titulo: "Angular",
            descripcion: "Construcción de aplicaciones web de una solapágina.",nivel: "Aprendizaje Activo",
            botonTexto: "VER CERTIFICADO",
            estado: "completado"
        },
        {
